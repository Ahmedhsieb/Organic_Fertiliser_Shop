        ...
        <div class="row">
            <div class="page-header">
                <div class="d-flex align-items-center">
                    <h2 class="page-header-title">Update Teacher</h2>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                    ...
                    <div class="widget-body">
                        ...
                        <form method="post" action="{{route('admin.teacher.update')}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row d-flex align-items-center mb-5">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="specialist" value="{{$teacher->specialist}}" class="form-control">
                                    <small>
                            ...
                            <div class="form-group row d-flex align-items-center mb-5">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="linkedin" value="{{$teacher->linkedin}}" class="form-control">
                                    <small>
