...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('AdminAssets/img/favicon-32x32.png')}}">
    <!-- Stylesheet -->
    <link rel="stylesheet" href="{{asset('AdminAssets/vendors/css/base/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('AdminAssets/vendors/css/base/elisyam-1.5.min.css')}}">
    <link rel="stylesheet" href="{{asset('AdminAssets/css/base/animate/animate.min.css')}}">
...
<div id="preloader">
    <div class="canvas">
        <img src="{{asset('AdminAssets/img/logo.png')}}" alt="logo" class="loader-logo">
                ...
                <div class="tab-content" id="animate-tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane show active" id="singin" aria-labelledby="singin-tab">
                        ...
                        @if(Session::has('error'))
                            <div class="alert alert-danger-bordered alert-dissmissible fade show" role="alert">
                        ...
                        <form method="post" action="{{route('admin.post.login')}}">
                            ...
                            <div class="sign-btn text-center">
                                <button type="submit" class="btn  btn-gradient-01">
                                    Login
                                </button>
                            </div>
                        </form>
...
<!-- End Container -->
<!-- Begin Vendor Js -->
<script src="{{asset('AdminAssets/vendors/js/base/jquery.min.js')}}"></script>
<script src="{{asset('AdminAssets/vendors/js/base/core.min.js')}}"></script>
<!-- End Vendor Js -->
<!-- Begin Page Vendor Js -->
<script src="{{asset('AdminAssets/vendors/js/app/app.js')}}"></script>
<!-- End Page Vendor Js -->
