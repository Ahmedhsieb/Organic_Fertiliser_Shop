        ...
        <div class="row">
            <div class="page-header">
                <div class="d-flex align-items-center">
                    <h2 class="page-header-title">Update Course</h2>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                    ...
                    <div class="widget-body">
                        ...
                        <form method="post" action="{{route('admin.course.update')}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row d-flex align-items-center mb-5">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="kids_age" value="{{$course->kids_age}}" class="form-control">
                                    <small>
                            ...
                            <div class="form-group row d-flex align-items-center mb-5">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="seats_num" value="{{$course->seats_num}}" class="form-control">
                                    <small>
                            ...
                            <div class="form-group row d-flex align-items-center mb-5">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="time" value="{{$course->time}}" class="form-control">
                                    <small>
                            ...
                            <div class="form-group row d-flex align-items-center mb-5">
                                ...
                                <div class="col-lg-9">
                                    <textarea class="form-control" rows="5" name="desc">{{$course->desc}}</textarea>
                                    <small>
