            ...
            <div class="col-12">
                ...
                <div class="widget has-shadow">
                    ...
                    <div class="widget-body">
                        <form method="post" action="{{route('admin.kidkinder.update.social')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group row d-flex align-items-center mb-5">
                                <label class="col-lg-3 form-control-label">Social Key</label>
                                <div class="col-lg-9">
                                    <input type="text" value="{{$social->social_key}}" name="social_key" class="form-control">
                                    <small>
                            ...
                            <div class="form-group row d-flex align-items-center mb-5">
                                ...
                                <div class="col-lg-9">
                                    <textarea class="form-control" rows="5" name="social_value">{{$social->social_value}}</textarea>
                                    <small>
