            ...
            <div class="d-flex justify-content-start mt-4">
                @foreach($socials as $social)
                    <a class="btn btn-outline-primary rounded-circle text-center mr-2 px-0"
                       style="width: 38px; height: 38px;" href="{{$social->social_value}}"><i class="fab fa-{{$social->social_key}}"></i></a>
                @endforeach
...
<script src="{{asset('UserAssets/lib/isotope/isotope.pkgd.min.js')}}"></script>
<script src="{{asset('UserAssets/lib/lightbox/js/lightbox.min.js')}}"></script>

<!-- Contact Javascript File -->
<script src="{{asset('UserAssets/mail/jqBootstrapValidation.min.js')}}"></script>
<script src="{{asset('UserAssets/mail/contact.js')}}"></script>
